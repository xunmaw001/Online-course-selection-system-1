    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">成绩分布统计</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">成绩分布管理</li>
                        <li class="breadcrumb-item active">成绩分布统计</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    function getDetails() {
        let value = $("#kechengSelect").val();
        let name = $("#kechengSelect").find("option:selected").text();
        if(value == null || value == ""){
            alert("请选择课程");
            return false;
		}
