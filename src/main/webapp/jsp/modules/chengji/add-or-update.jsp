                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="kechengId" name="kechengId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6 chengjiDefenDiv">
                                        <label>成绩得分</label>
                                        <input style="width: 450px" id="chengjiDefen" name="chengjiDefen" class="form-control"
                                               onchange="chengjiDefenChickValue(this)" placeholder="成绩得分">
                                    </div>
...
<script>
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function chengjiDefenChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                chengjiDefen: "成绩得分不能为空",
                chengjiContent: "成绩详情不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#chengjiDefen").val(ruleForm.chengjiDefen);
