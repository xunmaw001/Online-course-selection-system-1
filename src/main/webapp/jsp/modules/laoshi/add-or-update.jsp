                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 laoshiRongyuDiv">
                                        <label>所获荣誉</label>
                                        <input style="width: 450px" id="laoshiRongyu" name="laoshiRongyu" class="form-control"
                                               placeholder="所获荣誉">
                                    </div>
                                    <div class="form-group  col-md-6 laoshiContentDiv">
                                        <label>老师介绍</label>
...
<script>
    ...
    function setContent() {
        ...
        <!-- 当前表的填充富文本框 -->
        if (ruleForm.laoshiContent != null && ruleForm.laoshiContent != 'null' && ruleForm.laoshiContent != '' && $("#laoshiContentupload").length>0) {

            var laoshiContentUeditor = UE.getEditor('laoshiContentEditor');
            laoshiContentUeditor.ready(function () {
                var mes = '';
                if(ruleForm.laoshiContent != null){
                    mes = ''+ ruleForm.laoshiContent;
                    // mes = mes.replace(/\n/g, "<br>");
                }
                laoshiContentUeditor.setContent(mes);
            });
        }
    }
    // 获取富文本框内容
    function getContent() {
        ...
        <!-- 获取当前表的富文本框内容 -->
        if($("#laoshiContentupload").length>0) {
            var laoshiContentEditor = UE.getEditor('laoshiContentEditor');
            if (laoshiContentEditor.hasContents()) {
                $('#laoshiContent-input').attr('value', laoshiContentEditor.getContent());
            }
        }
    }
    //数字检查
