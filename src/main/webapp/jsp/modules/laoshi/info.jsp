                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="laoshiRongyu" name="laoshiRongyu" class="form-control"
                                               v-model="ruleForm.laoshiRongyu" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.laoshiContent != null && ruleForm.laoshiContent != 'null' && ruleForm.laoshiContent != '') {
            var laoshiContentUeditor = UE.getEditor('laoshiContentEditor');
                laoshiContentUeditor.ready(function () {
                    ...
                    laoshiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
