                                ...
                                <input id="laoshiId" name="laoshiId" v-model="ruleForm.laoshiId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="kechengDaima" name="kechengDaima" class="form-control"
                                               v-model="ruleForm.kechengDaima" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>院系</label>
                                    <input style="width: 450px" id="yuanxiValue" name="yuanxiValue" class="form-control"
                                           v-model="ruleForm.yuanxiValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>课程性质</label>
                                    <input style="width: 450px" id="kechengXingzhiValue" name="kechengXingzhiValue" class="form-control"
                                           v-model="ruleForm.kechengXingzhiValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>课程学分</label>
                                        <input style="width: 450px" id="kechengXuefen" name="kechengXuefen" class="form-control"
                                               v-model="ruleForm.kechengXuefen" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="kechengZongxueshi" name="kechengZongxueshi" class="form-control"
                                               v-model="ruleForm.kechengZongxueshi" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>考核方式</label>
                                    <input style="width: 450px" id="kechengKaoheValue" name="kechengKaoheValue" class="form-control"
                                           v-model="ruleForm.kechengKaoheValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>最大选课人数</label>
                                        <input style="width: 450px" id="kechengRenshu" name="kechengRenshu" class="form-control"
                                               v-model="ruleForm.kechengRenshu" readonly>
                                    </div>
